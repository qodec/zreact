...
export default function Home() {
  let [inputText, setInputText] = useState("I am Fantastico");
  let [bannerText, setBannerText] = useState("I am Fantastico");
  ...
  return (
    <div>
      ...
      <section id="features" className="bg-gray-300 py-6 text-center">
        <h2 className="text-3xl opacity-50 p-0 m-0">Hello Hey Hi,</h2>
        <div>Tell me how you feel</div>
